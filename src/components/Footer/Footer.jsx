...
const Footer = () => {
  ...
  <p className="text-sm text-gray-500">
    At The Fitness Solution, we are dedicated to helping you achieve your fitness goals with our state-of-the-art facilities and expert trainers. Whether you're a beginner or a seasoned athlete, our personalized programs and supportive community will inspire and motivate you every step of the way.
  </p>
  <p className="mt-4 text-sm text-gray-500">
    Join us today and experience a transformative journey towards a healthier, stronger, and more confident you. Your fitness success is our mission.
  </p>
</div>
      </div>
      ...
      <div>
        ...
        <p className="mt-4 text-sm text-gray-500">
          Follow Us on Our Social Media Platforms to Stay Updated With Our Latest News and Offers.
        </p>
      </div>
    </div>
