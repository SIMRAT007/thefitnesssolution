      ...
      <section className="py-0">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className=" p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl" style={{ background: 'linear-gradient(to left, #424735, black)' }}>
              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <label className="flex items-center space-x-2 cursor-pointer">
                      ...
                      <div className="w-5 h-5 rounded-full border-2 border-gray-500 flex items-center justify-center transition-all duration-300">
                        {formData.preferredMethod === "email" && (
                          <div className="w-3 h-3 bg-[#98cd05] rounded-full"></div>
                        )}
                      </div>
                ...
                <button
                  type="submit"
                  className="w-full h-12 flex items-center justify-center bg-[#f1ffc6] hover:bg-[#f1fdd8] text-black rounded-full transition duration-700"
                  disabled={loading}
                >
                  {loading ? (
